...
exports.computeSurprisePotential = computeSurprisePotential;
exports.computeCrowdingRisk = computeCrowdingRisk;
exports.classifyPrep = classifyPrep;
exports.buildPrepBoardItem = buildPrepBoardItem;
exports.computeEpsSurprise = computeEpsSurprise;
exports.computePriceReaction = computePriceReaction;
exports.classifyReaction = classifyReaction;
exports.buildReactionItem = buildReactionItem;
exports.classifyDrift = classifyDrift;
exports.buildDriftItem = buildDriftItem;
/**
 ...
 */
function computeSurprisePotential(event) {
 ...
 */
function computeCrowdingRisk(event) {
 ...
 */
function buildPrepBoardItem(event) {
    const surprisePotential = computeSurprisePotential(event);
 ...
 */
function computeEpsSurprise(event) {
 ...
 */
function computePriceReaction(event) {
 ...
 */
function classifyReaction(event) {
    const reasons = [];
 ...
 */
function buildReactionItem(event) {
